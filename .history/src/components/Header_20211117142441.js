				...
				<div class="flex justify-between">
					<div class="flex space-x-7">
						...
						<div class="hidden md:flex items-center space-x-1">
							<a href="" class="py-4 px-2 text-green-500 border-b-4 border-green-500 font-semibold "><Link activeClass="active"
              to="contact" spy={true} smooth={true} duration={500}>Home</Link></a>
