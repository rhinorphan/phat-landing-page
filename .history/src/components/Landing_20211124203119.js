  ...
  return (
    <div name="landing" id="container">
      <div class="flex flex-col items-center justify-center text-center overlay">
        ...
        <button class="m-2 bg-white rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider text-green-500 transition duration-300 hover:text-white btn">
          <a className='hover:bg-green-400 btn-primary' target="_blank" rel="noopener noreferrer" href="#"><Link activeClass="active"
