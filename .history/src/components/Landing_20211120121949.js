  ...
  return (
    <div className="flex flex-col md:flex-row-reverse md:py-20 px-4" name="landing">
      ...
      <div class="flex flex-col items-center justify-center mx-24 text-center">
        ...
        <button class="m-4 bg-white rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider text-green-500transition duration-300 hover:text-white pushable">
