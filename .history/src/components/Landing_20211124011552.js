...
const Landing = () => {
  ...
  return (
    <div id="container">
        <h2 class="text-xl font-bold mb-2 text-green-500 md:text-2xl lg:text-4xl bg-transparent">
        ...
        <button class="m-2 mt-4 rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider text-green-500transition duration-300 hover:text-white pushable">
        ...
        <button class="m-2 rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider text-green-500 transition duration-300 hover:text-white pushable">
