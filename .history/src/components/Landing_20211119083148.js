...
function Landing() {
  return (
    <div className="flex flex-col md:flex-row-reverse h-100 py-20 px-4" name="landing">
      ...
      <div class="flex flex-1 flex-col items-center justify-center mx-24 text-center">
        <h2 class="text-2xl  font-bold mb-2 text-green-500 md:text-4xl">
          Community Arcade Cabinet
        </h2>
        <h3 class="text-xl mb-2 text-gray-300 md:text-left md:text-2xl">
        With your beloved games.
        </h3>
        <h3 class="text-l mb-2 text-green-500 md:text-left md:text-xl">
        Join the revolution!
        </h3>
