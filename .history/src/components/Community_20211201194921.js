  ...
  return (
    <section className="flex flex-col place-items-center h-100 py-20 px-4" name="community">
      <div className="w-min-50">
        <img src={`${process.env.PUBLIC_URL}/assets/images/arcade.png.gif`} alt="" className="center" />
      </div>
      <div class="mx-16 w-50">
        <h2 class="header-wrap mb-8">
        Party Hats?
        </h2>
        <h3 class="flex text-2xl mb-2 text-white text-center normalText">
      ...
      <div class="flex justify-between text-center">
          <div class="flex flex-col md:flex-row gap-4">
            <div class="flex flex-col md:flex-row gap-4">
              <div class="flex bg-transparent w-full mb-8">
