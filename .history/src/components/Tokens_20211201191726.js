    ...
    <section name="token" className="flex flex-col md:flex-row justify-center py-20 px-4">
      ...
      <div className="flex flex-col text-center md:mr-20 md:w-3/4 items-center">
        ...
        <div class="shadow-md mt-10">
          ...
          <p className="text-white pt-10 pb-10">$HAT - Party Hat Token (Game Token)</p>
        <p className="flex text-2xl mb-2 text-white normalText">This Token will maybe be on the Harmony Protocol Chain to keep gas fees extremely low so that claiming wont need to be a part of your budget when earning tokens! This token will be used for all the arcade games to come and will be the main token for most things.</p>
      </div>
    </section>
  )
}
