...
function About() {
  return (
    <section name="about" className="h-100 container px-5 py-24 mx-auto flex-col">
      <div>
        <p className="flex text-4xl  font-bold mb-2 text-green-500 justify-center">Meet the Team</p>
      </div>
      <div class="flex flex-col sm:flex-row gap-4">
			...
			<div class="flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
				...
				<h6 class="mt-2 text-sm font-medium text-green-500 normalText">Founder</h6>

				<p class="text-xs text-gray-500 text-center mt-3 normalText">
			...
			<div class="flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
				...
				<h6 class="mt-2 text-sm font-medium text-green-500 normalText">CFO</h6>
			...
			<div class="flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
				...
				<h6 class="mt-2 text-sm font-medium text-green-500 normalText">Marketing</h6>
