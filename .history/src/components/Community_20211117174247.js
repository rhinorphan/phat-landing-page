            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  Our goal is primarily to to people who have lost money to get back on their feet. And to create a community that helps each other besides just themselves.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold text-green-500">Verified Company</h6>
