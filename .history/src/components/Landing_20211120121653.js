    ...
    <div className="flex flex-col md:flex-row-reverse md:py-20 px-4" name="landing">
      ...
      <div class="flex flex-col items-center justify-center mx-24 text-center">
        ...
        <button class="m-2 bg-white rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider text-green-500 hover:bg-green-400 transition duration-300 hover:text-white pushable">
          <a className="front" target="_blank" rel="noopener noreferrer" href="https://lionell-moore.gitbook.io/crypto-party-hats/introductions/what-is-party-hats">Whitepaper</a>
        </button>
