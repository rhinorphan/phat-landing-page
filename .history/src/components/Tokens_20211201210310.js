      ...
      <div className="flex flex-col text-center md:mr-20 md:w-3/5 items-center">
        ...
        <div class="shadow-md mt-10">
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400 normalText">
            ...
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400">
                  <p class="p-5 normalText">100M $PHAT</p>
               </div>
            </div>
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400">
                  <p class="p-5 normalText">7% of which:</p>
                  <p className="pb-5 normalText">6% goes to Liquidity <br />1% goes to Holders of Phat</p>
               </div>
            </div>
          </div>
