...
function About() {
  return (
    <section name="about" className="h-100 container px-5 py-24 mx-auto flex-col justify-center">
      <div>
        <p className="sm:text-4xl text-2xl font-medium title-font mb-4 text-green-500 justify-center items-center">Meet the Team</p>
      </div>
