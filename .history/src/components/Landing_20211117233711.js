...
function Landing() {
  return (
    <section className="grid text-center md:flex md:text-left items-center justify-center h-screen py-10 px-4" name="landing">
      <div class="mx-16">
        <h2 class="text-4xl  font-bold mb-2 text-green-500">
          Community Arcade Cabinet
        </h2>
        <h3 class="text-xl mb-2 text-gray-300">
        With your beloved games.
        </h3>
        <h3 class="text-xl mb-8 text-green-500">
        Join the revolution!
        </h3>
