        ...
        <div className="container px-5 py-20 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto py-2 px-8 font-medium text-white bg-green-500 rounded hover:bg-green-400 transition duration-300 pushable">
                  <p className="front">Send<p>
                </button>
              </div>
            </div>
          </div>
