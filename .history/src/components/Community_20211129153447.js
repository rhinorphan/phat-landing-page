          ...
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              <div class="flex flex-col flex-wrap w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto neon-box neon-box__1">
                  <div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400 neon-box neon-box__1">
