...
function Tokens() {
  return (
    <section name="token" className="flex flex-col md:flex-row justify-center py-20 px-4">
      ...
      <div className="flex flex-col text-center md:mr-20 md:w-3/4 justify-items-center">
        ...
        <div class="shadow-md">
            <div class="tab w-full overflow-hidden border-t">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 normalText">
