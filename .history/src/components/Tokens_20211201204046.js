...
function Tokens() {
  return (
    <section name="token" className="flex flex-col md:flex-row justify-center py-20 px-4">
      ...
      <div className="flex flex-col text-center md:mr-20 md:w-3/5 items-center">
        ...
        <div class="shadow-md mt-10">
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400">
                  <p class="p-5 text-xxs md:text-sm">0x7756e4d80def722b28ed0cab68f5d132d91a3ea5</p>
               </div>
            </div>
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400">
                  <p class="p-5 text-xxs md:text-sm">100M $PHAT</p>
               </div>
            </div>
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400">
                  <p class="p-5 text-xxs md:text-sm">7% of which:</p>
                  <p className="pb-5 text-xxs md:text-sm">6% goes to Liquidity <br />1% goes to Holders of Phat</p>
               </div>
            </div>
          </div>
