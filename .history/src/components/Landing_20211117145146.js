...
function Landing() {
  return (
    <section className="grid md:flex place-items-center h-screen py-10 px-4" name="landing">
      <div class="mx-auto ml-32">
        <h2 class="text-4xl  font-bold mb-2 text-green-500">
          A Community Based P2E
        </h2>
        <h3 class="text-2xl mb-8 text-gray-200">
          Join the revolution.
        </h3>

        <button class="bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider text-green-500 hover:bg-green-400 transition duration-300 hover:text-white">
        ...
        <button class="m-2 bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider text-green-500 hover:bg-green-400 transition duration-300 hover:text-white">
          <a target="_blank" rel="noopener noreferrer" href="https://lionell-moore.gitbook.io/crypto-party-hats/introductions/what-is-party-hats">Learn More</a>
        </button>
      </div>
