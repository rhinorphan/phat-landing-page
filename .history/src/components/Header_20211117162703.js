  ...
  return (
    <nav class="bg-white shadow-lg sticky top-0">
			<div class="max-w-6xl mx-auto px-4">
              ...
              <li style="decoration: none"><Link activeClass="active" className="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300 cursor-pointer"
