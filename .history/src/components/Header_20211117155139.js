    ...
    <nav class="bg-white shadow-lg sticky top-0">
			...
			<div class="hidden mobile-menu">
              ...
              to="landing" spy={true} smooth={true} duration={500}>Home</Link></li>
					<li><Link activeClass="active2" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white cursor-pointer"
              to="community" spy={true} smooth={true} duration={500}>Community</Link></li>
          <li><Link activeClass="active2" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white cursor-pointer"
              to="token" spy={true} smooth={true} duration={500}>Token</Link></li>
					<li><Link activeClass="active2" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white cursor-pointer"
