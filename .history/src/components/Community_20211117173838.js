  ...
  return (
    <section className="grid md:grid place-items-center h-100 py-10 px-4" name="community">
      ...
      <div class="mx-16 w-50">
        ...
        <h3 class="flex text-2xl mb-2 text-gray-300 text-center">
        ...
        <section class="pb-10 bg-blueGray-200 mt-8">
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold text-green-500">Community</h6>
                  <p class="mt-2 mb-4 text-gray-500">
                  Our goal is primarily to to people who have lost money to get back on their feet.</p>
                  <p class="mt-2 mb-4 text-gray-500">
                  Creates a community that helps each other besides just themselves.
                  </p>
                  <p class="mt-2 mb-4 text-gray-500">
                  Creates a safe space for people to hang out without needing to worry about the projects health.
                  </p>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold text-green-500">Transparency</h6>
