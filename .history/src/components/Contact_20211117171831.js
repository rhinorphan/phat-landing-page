...
function Contact() {
  ...
  return (
    <section 
      className="text-gray-700 body-font" name="contact">
        <div className="container px-5 py-18 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4 text-green-500">
              Contact Us
            </h1>
            ...
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                ...
                <span className="inline-flex">
                  ...
                  <a className="ml-4 text-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
