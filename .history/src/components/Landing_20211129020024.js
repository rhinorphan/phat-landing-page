...
const Landing = () => {
  ...
  return (
    <div name="landing" id="container" className="h-screen">
      <div class="flex flex-col items-center justify-center text-center overlay">
        <img src={`${process.env.PUBLIC_URL}/assets/images/landing-logo.png`}/>
        <h3 class="text-sm mb-2 mt-8 text-white md:text-l lg:text-xl">
        Join the revolution!
        </h3>
