  ...
  return (
    <nav class="bg-white shadow-lg sticky top-0">
            ...
            <button className="pushable">
              <a target="_blank" rel="noopener noreferrer" href="https://tetr.io/" class="text-sm py-2 px-8 font-medium text-white bg-green-50hover:bg-green-4000 hover:bg-green-400 transition duration-300 rounded-full front">Play</a>
            </button>
					</div>
