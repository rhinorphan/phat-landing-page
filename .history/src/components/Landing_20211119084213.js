  ...
  return (
    <div className="flex flex-col md:flex-row-reverse h-100 md:py-20 px-4" name="landing">
      ...
      <div class="flex flex-1 flex-col items-center justify-center mx-24 text-center">
        <h2 class="text-xl  font-bold mb-2 text-green-500 md:text-2xl md:text-left lg:text-4xl">
          Community Arcade Cabinet
        </h2>
        <h3 class="text-l mb-2 text-gray-300 md:text-xl md:text-left lg:text-2xl lg:text-left">
