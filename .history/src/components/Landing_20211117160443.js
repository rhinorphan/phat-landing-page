  ...
  return (
    <section className="grid md:flex place-items-center h-screen py-10 px-4" name="landing">
      <div class="mx-16">
        ...
        <button class="m-2 bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider text-green-500 hover:bg-green-400 transition duration-300 hover:text-white mx-center">
