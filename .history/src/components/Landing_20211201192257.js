  ...
  return (
    <div name="landing" id="container">
      <div class="flex flex-col items-center justify-center text-center overlay">
        ...
        <button class="m-2 mt-4 bg-white rounded-full py-4 px-8 shadow-lg uppercase text-sm tracking-wider transition duration-300 hover:text-white pushable">
          <a className='hover:bg-pink-400 front' href=""><Link activeClass="active"
