...
function About() {
  return (
    <section name="about" className="h-100 container px-5 py-24 mx-auto flex-col items-center justify-center">
      <div>
        <p className="sm:text-4xl text-2xl font-medium title-font mb-4 text-green-500">Meet the Team</p>
      </div>
