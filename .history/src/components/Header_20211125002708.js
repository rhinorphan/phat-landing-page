  ...
  return (
    <nav class="bg-white shadow-lg top-0 relative">
            ...
            <button className="pushable">
              <a target="_blank" rel="noopener noreferrer" href="https://tetr.io/" class="text-sm py-2 px-8 font-medium text-white bg-green-500 hover:bg-pink-300 transition duration-300 rounded-full front">Play</a>
            </button>
					</div>
