  ...
  return (
    <section name="token" className="flex flex-col md:flex-row justify-center py-20 px-4">
      <div className="h-100 w-100">
        <img src={`${process.env.PUBLIC_URL}/assets/images/token.gif`} alt="" className="md:object-none md:object-bottom-right" />
      </div>
      <div className="flex flex-col text-center md:mr-20 md:w-2/5 items-center">
        ...
        <div class="shadow-md mt-10">
            <div class="tab w-full overflow-hidden border">
               ...
               <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-pink-400 normalText md:text-sm">
