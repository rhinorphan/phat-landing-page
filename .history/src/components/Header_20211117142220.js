    ...
    <nav class="bg-white shadow-lg">
			<div class="max-w-6xl mx-auto px-4">
              ...
              <a href="#" class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Token</a>
							...
							<a href="#" class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300"><Link activeClass="active" className="test6" to="contact" spy={true} smooth={true} duration={500}>Contact Us</Link></a>
						</div>
					</div>
