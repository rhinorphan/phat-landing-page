      ...
      <div class="container mx-auto px-4">
          <div class="flex flex-col md:flex-row items-center">
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="flex flex-col min-w-0 break-words bg-transparent w-full mb-8 shadow-lg rounded-lg neon-box neon-box__1">
                <div class="px-4 py-5 flex-auto">
                  <div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full neon-box neon-box__1">
