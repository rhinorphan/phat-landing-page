  ...
  return (
    <nav class="bg-white shadow-lg sticky top-0">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					<li><a href="index.html" className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white"><Link activeClass="active2"
              to="landing" spy={true} smooth={true} duration={500}>Home</Link></a></li>
					<li><a href="#community" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white"><Link activeClass="active2"
          ...
          <li><a href="#" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white"><Link activeClass="active2"
              to="token" spy={true} smooth={true} duration={500}>Token</Link></a></li>
					<li><a href="#about" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white"><Link activeClass="active2"
              to="about" spy={true} smooth={true} duration={500}>About</Link></a></li>
					<li><a href="#contact" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 hover:text-white">Contact</a></li>
				</ul>
			</div>
		</nav>
  )
